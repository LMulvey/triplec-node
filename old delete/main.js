...
var InfiniteRotator =
{
    init: function()
    {
        ...
        if($('.button-bathrooms').hasClass('button-long') == false && $('.button-kitchens').hasClass('button-long') == false && $('.button-others').hasClass('button-long') == false) {
          //show first items
        ...
        $('.button-bathrooms').css('background-image', 'url(' + imgUrl + "Bathroom/2_thumb.jpg" + ')');
        $('.button-kitchens').css('background-image', 'url(' + imgUrl + "kitchen/3_thumb.png" + ')');
        $('.button-others').css('background-image', 'url(' + imgUrl + "Other/5_thumb.jpg" + ')');
      }
    }
};
