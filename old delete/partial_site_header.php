...
<head>
    ...
    <title>Triple C Woodworx - Custom Furniture by Marc Bünder</title>
...
<?php if($gallery) { ?>
    <!-- Choclat.js -- sweet lightbox plugin -->
    ...
    <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                <a href="http://www.triplec.ca"><img src="./img/triplec-logo.png"></a>
